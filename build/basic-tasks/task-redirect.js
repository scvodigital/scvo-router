...
var TaskRedirect = /** @class */ (function (_super) {
    __extends(TaskRedirect, _super);
    function TaskRedirect() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TaskRedirect.prototype.execute = function (routeMatch, routeTaskConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var config, location;
            return __generator(this, function (_a) {
                config = routeTaskConfig.config;
                location = routeMatch.getString(config.location);
