...
var TaskFirebaseRtbGet = /** @class */ (function (_super) {
    __extends(TaskFirebaseRtbGet, _super);
    function TaskFirebaseRtbGet(apps) {
        var _this = _super.call(this) || this;
        _this.apps = apps;
        return _this;
    }
    TaskFirebaseRtbGet.prototype.execute = function (routeMatch, routeTaskConfig, renderer) {
        return __awaiter(this, void 0, void 0, function () {
            var config, appName, app, path, snapshot, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, renderer.render(config.pathTemplate, routeMatch)];
                    case 1:
                        path = _a.sent();
