...
require("handlebars-helpers/index");
require("handlebars-helpers/logging");
require("handlebars-helpers/match");
require("handlebars-helpers/misc");
require("handlebars-helpers/object");
require("handlebars-helpers/regex");
require("handlebars-helpers/url");
require("handlebars-helpers/code");
require("handlebars-helpers/comparison");
require("handlebars-helpers/fs");
require("handlebars-helpers/i18n");
require("handlebars-helpers/inflection");
require("handlebars-helpers/markdown");
require("handlebars-helpers/math");
require("handlebars-helpers/number");
require("handlebars-helpers/path");
require("handlebars-helpers/string");
require("handlebars-helpers/utils");
